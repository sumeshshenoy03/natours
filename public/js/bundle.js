  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            uri = type === 'data' ? 'updateMe' : 'updatePassword';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/".concat(uri),
              data: data
            });
...
var stripe = Stripe('pk_test_51KFHlPJzJpFLVCVsX5NOymjfSv6nMSc0sDZYpqe8ly4oOB3h0rKvgfrLly24tfePeG9WdbVF7ld247DgFaN2HAD60039YtuupS');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your registration was successful, please login now');
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
